...
module.exports = {
    name: "messages",
	description: "Xem 5 tin nhắn mới nhất",
    aliases: ['msgs'],
	delay: 10,
    ...
    async execute(client, message, args) {
		...
		let quotes = new Scriptdb(`${client.disk}/data/quotes/${args[0]}.json`)
		let messages = quotes.get('messages')
		let times = quotes.get('times')

		if(times == undefined || messages == undefined) return message.lineReplyNoMention(client.userNotFound).then(msg => msg.delete({timeout: 60000}));
